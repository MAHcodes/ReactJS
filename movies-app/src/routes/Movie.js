...
const Movie = ({ username, avatarType }) => {
  let { id } = useParams();
        ...
        {isLoading ? (
          ...
          <div className={classes.main}>
            <div
              ...
              style={{
                backgroundImage: `url(${movieData.posters?.backdrops[0]?.link})`,
              }}
            >
              <div className={classes.content}>
                ...
                <div className={classes.aboutMovie}>
                  <p>{`${movieData.contentRating || "Content Rating"} • ${
                    movieData.year || "Year"
                  } • ${movieData.genres || "Genres"} • ${
                    movieData.runtimeStr || "Duation"
                  }`}</p>
                  <div className={classes.rating}>
                    <span className={classes.rate}>
                      <p>
                        {movieData.imDbRating} <small>/10</small>
                      </p>
                    ...
                    <p className={classes.votes}>
                      {(
                        Number(movieData.imDbRatingVotes) || ""
                      ).toLocaleString()}{" "}
                      votes
                    </p>
                  </div>
            ...
            <div className={`${classes.moreInfo} ${classes.grid}`}>
              ...
              <div className={classes.more}>
                ...
                <p>
                  <span>Budget:</span> {movieData.boxOffice?.budget}
                </p>
                <p>
                  <span>Cumulative World Wide Gross:</span>{" "}
                  {movieData.boxOffice?.cumulativeWorldwideGross}
                </p>
              </div>
